<template>
  <v-app id="home">
    ...
    <v-container fluid>
        ...
        <v-row>
          <v-col cols="5">
            <div style="position: relative" class="mt-16">
              ...
              <h1 class="text-white">We are Finder Home Community</h1>
              <span class="text-grey">Integration of Institutionalized Children</span><br />
        ...
        <div>
          <v-row>
            ...
            <v-col cols="12" sm="6">
              ...
              <h4 class="mt-n4">Our Mission is to reconnect families</h4>
              <h4 class="">And make vulnerable children experience love again</h4>
              <p class="text-grey">
      ...
      <v-col cols="12" class="padd" id="mission">
            ...
            <v-col cols="12">
              <div class="child">
                <v-btn
                  ...
                  class="text-white"
                ></v-btn>
                <h3 class="ml-3 mt-4">Reconnect Families</h3>
              ...
              <div class="child">
                <v-btn
                  ...
                  class="text-white"
                ></v-btn>
                <h3 class="ml-3 mt-4">Check Well-Being of Reintegrated Children</h3>
                <p class="text-grey ml-3 mt-4 text-caption">
                  Lorem, ipsum dolor sit amet <br />consectetur adipisicing
                  <br />consectetur adipis
                </p>
              ...
              <div class="child">
                <v-btn
                  ...
                  class="text-white"
                ></v-btn>
                <h3 class="ml-3 mt-4">Provide Financial Support to Reintegrated Children</h3>
                <p class="text-grey ml-3 mt-4 text-caption">
                  Lorem, ipsum dolor sit amet <br />consectetur adipisicing
                  <br />consectetur adipis
                </p>
      ...
      <v-col cols="12" sm="12" id="services">
        <div class="d-flex justify-center mb-6">
          ...
          <v-btn class="mr-2" variant="tonal">Reconnected Families</v-btn>
          <v-btn class="mr-2" variant="tonal">Community</v-btn>
          <v-btn class="mr-2" variant="tonal">Upcoming Projects</v-btn>
      ...
      <v-col cols="12" id="testimonials">
        <div class="testimonials">
          <h2 class="mt-5">What Families Say</h2>
          <v-row>
            <!-- Testimonial 1 -->
            <v-col cols="12" sm="4">
      ...
      <v-col cols="12" id="howtohelp">
        <div class="hire">
          <v-row>
            <v-col cols="12" sm="8">
              <h1 class="mt-9">Let Us Work Together</h1>
              <p class="text-grey">
            ...
            <v-col cols="12" sm="4">
              <v-btn color="#FBDF7E" class="mt-15">Contact Us</v-btn>
            </v-col>
          </v-row>
        </div>
      </v-col>      
        ...
        <v-row>
          <v-col cols="12" sm="4">
            <div class="child">
              ...
              ></v-btn
              ><br />
              <span class="text-caption">Nairobi,Kenya </span
              ><br />
              <v-btn
              ...
              ></v-btn
              ><br />
              <span class="text-caption">+2541234567 </span> <br />
              <span class="text-caption">+2541234567 </span> <br />
              <v-btn
              ...
              ></v-btn
              ><br />
              <span class="text-caption">finderhome@gmail.com </span> <br />
              <span class="text-caption">finderhome@gmail.com </span> <br />
            </div>
          </v-col>
          <v-col cols="12" sm="8">
