                  ...
                  <v-row>
                    <v-col cols="12" md="6">
                      <v-card-text class="mt-12">
                        ...
                        >Log in to your account <br>and be part of our society</h6>
                        <v-row align="center" justify="center">
                          <v-col cols="12" sm="8">
                          <v-text-field
                            v-model="email"
                         ...
                         <h5
                          class="text-center  grey--text mt-4 mb-3">Or Log in using</h5>
                    ...
                    <div style="  text-align: center; padding: 180px 0;">
                      <v-card-text class="white--text" >
                        ...
                        <h6 class="text-center" >Let's get you all set up so you can start creating your first<br>onboarding experience</h6>
                      </v-card-text>
                  ...
                  <v-row >
                    <v-col cols="12" sm="6" class="blue rounded-br-xl">
                     <div style="  text-align: center; padding: 180px 0;">
                      <v-card-text class="white--text" >
                        ...
                        <h6  class="text-center">Log in to your account so you can <br>join our community</h6>
                      </v-card-text>
                      <div class="text-center">
                    ...
                    <v-col cols="12" sm="6">
                      <v-card-text class="mt-12">
                        ...
                        <h6 class="text-center  grey--text " >Let's get you all set up so you can start creating your <br>account</h6>
                        <v-row align="center" justify="center">
                          <v-col cols="12" sm="8">
                           <v-row>
                           <v-col cols="12" sm="6">
